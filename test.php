...
<html lang="en">
  <head>
	...
	<!-- Getting the IP address form the ll2io  -->
  ...
  <body>
      ...
      <div class="container">
        ...
        <div id="navbar" class="collapse navbar-collapse">
          <ul class="nav navbar-nav">
            <li><a href="/index.html">Test Speed</a></li>
            <li class="active"><a href="/myResult.html">My Results</a></li>
            <li><a href="../../line.html">About</a></li>
          </ul>
        </div><!--/.nav-collapse -->
      </div>
    </nav>
	...
	<script>console.log(userip)</script>
	<script>
